...
public class TReportTemplateTest extends BaseTest {
	...
	public void insert() {
		...
		// noise.setType("noise");
		// noise.setContent(
		// "噪音，会影响人类的生活。从总体讲噪音是由物体振动产生，凡是妨碍人们正常休息、学习和工作的声音，以及对人们要听的声音产生干扰的声音。噪音污染主要来源于交通运输、车辆鸣笛、工业噪音、建筑施工、社会噪音如音乐厅、高音喇叭、早市和人的大声说话等。且随工业与交通的发展而日
		// 趋严重，噪音污染是除大气污 染，水体污染外的城市第三大污染。");
		...
		// + "总悬浮颗粒物：是指漂浮在空气中的固态和液态颗粒物的总称，其粒径范围约为0.1-100
		// 微米。有些颗粒物因粒径大或颜色黑可以为肉眼所见，如烟尘。有些则小到使用电子显微镜才可观察到。通常把环境空气中空气动力学当量直径在10微米以下的颗粒物称为PM10，又称为可吸入颗粒物或飘尘。其中粒径小于等于
		// 2.5微米的颗粒物为PM2.5，它能较长时间悬浮于空气中，其在空气中含量浓度越高，就代表空气污染越严重。虽然PM2.5只是地球大气成分中含量很少的组分，但它对空气质量和能见度等有重要的影响。与较粗的大气颗粒物相比，PM2.5粒径小，面积大，活性强，易附带有毒、有害物质（例如，重金属、微生物等），且在大气中的停留时间长、输送距离远，因而对人体健康和大气环境质量的影响极大。颗粒物的直径越小，进入呼吸道的部位越深。10微米直径的颗粒物通常沉积在上呼吸道，5微米直径的可进入呼吸道的深部，2微米以下的可100%深入到细支气管和肺泡。\n"
		// +
		// "二氧化氮：是一种棕红色、高度活性的气态物质。二氧化氮在臭氧的形成过程中起着重要作用。人为产生的二氧化氮主要来自高温燃烧过程的释放，比如机动车、电厂废气的排放等。
		// 二氧化氮还是酸雨的成因之一。二氧化硫：是一种常见的和重要的大气污染物，是一种无色有刺激性的气体。二氧化硫主要来源于含硫燃料（如煤和石油）的燃烧；含硫矿石（特别是含硫较多的有色金属矿石）的冶炼；化工、炼油和硫酸厂等的生产过程。氮氧化物：种类很多，但主要是一氧化氮(NO)和(NO2)，它们是常见的大气污染物。一氧化碳：是煤、石油等含碳物质不完全燃烧的产物，是一种无色、无臭、无刺激性的有毒气体，几乎不溶于水，在空气中不易与其他物质产生化学反应，故可在大气中停留2～3年之久。如局部污染严重，对人群健康有一定危害。\n"
		// +
		...
		// volume.setName("容积率");
		// volume.setContent(
		// "容积率又称建筑面积毛密度，指项目用地范围内地上总建筑面积与项目总用地面积的比值。容积率是衡量建设用地使用强度的一项重要指标，对于开发商来说，容积率决定地价成本在房屋中占的比例，而对于住户来说，容积率直接涉及到居住的舒适度。现行城市规划法规体系下编制的各类居住用地的控制性详细规划，一般而言，容积率分为：独立别墅为0.2~0.5,联排别墅为0.4~0.7,6层以下多层住宅为0.8~1.2,，11层小高层住宅为1.5~2.0,18层高层住宅为1.8~2.5,19层以上住宅为2.4~4.5,住宅小区容积率小于1.0的，为非普通住宅。
		// 在计算容积率时，建筑面积一般按照《建筑工程建筑面积计算规范》（GB/T50353-2013）的规定计算；存在以下特殊情况:
		// 1、建筑底层架空作为通道、公共停车、布置绿化小品、居民休闲、配套设施等公共用途的，架空层层高宜在2.8
		// 米至3.6米之间，其建筑面积不计入容积率;
		...
		TReportTemplate chemical = new TReportTemplate();
		chemical.setCode(WebHelper.getInstance().getUniqueCode("T"));
		chemical.setType("chemical");
		chemical.setName("化工厂");
		chemical.setContent(
				"伴随着中国经济高速发展，中国的化工产品价格也在节节攀升。一位内部人士说，当年有的化工产品价格甚至能达到原材料成本的 5 至 6 倍。所以说，一个地区的化工产业可以极好地带动该地区的经济发展。化工厂多依水而建，往往充足的水源可以吸引更多的化工企业。但是，中国的化工产业因此存在很多问题。很多企业一般不愿意购买处理污染的设备。这导致了严重的空气污染和水污染。");
